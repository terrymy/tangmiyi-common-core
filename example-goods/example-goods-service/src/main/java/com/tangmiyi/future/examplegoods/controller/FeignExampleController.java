...
import com.tangmiyi.future.examplegoods.feign.OrderPropertiesSnowFeign;
...
public class FeignExampleController {
    ...
    @Autowired
    private OrderPropertiesSnowFeign orderPropertiesSnowFeign;
    ...
    public ResultBean testFeign() {
        ...
        return orderPropertiesSnowFeign.pageList(propertiesSnowPageParam);
    }
}
